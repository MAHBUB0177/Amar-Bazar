     ...
     <div  style={{marginTop:'20px'}}>
      ...
      <div className='row container ' style={{display:'flex'}}>
            <div className='col-md-3 founder' >
                          <Card style={{ width: '16rem' ,height:'200px', marginLeft:'40px',}}>
            ...
            <div className='col-md-3 founder' >
                          <Card style={{ width: '16rem' ,height:'200px', marginLeft:'50px',}}>
            ...
            <div className='col-md-3 founder ' >
                          <Card style={{ width: '16rem' ,height:'200px', marginLeft:'50px',marginBottom:'10px'}}>
